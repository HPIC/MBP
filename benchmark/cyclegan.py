...
if __name__=='__main__':
    ...
    with open('./loss/cyclegan_origin_loss_value.json', 'w') as file:
        ...
        for epoch in range(epochs):
            ...
            torch.save(G_A.state_dict(), f"./parameters/cyclegan_origin/G_A.pth")
            torch.save(G_B.state_dict(), f"./parameters/cyclegan_origin/G_B.pth")
            torch.save(D_A.state_dict(), f"./parameters/cyclegan_origin/D_A.pth")
            torch.save(D_B.state_dict(), f"./parameters/cyclegan_origin/D_B.pth")
